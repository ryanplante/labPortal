...
import { View, Text, StyleSheet, FlatList, TouchableOpacity, TextInput, Button, ActivityIndicator, Dimensions, Image } from 'react-native';
    ...
    <View key="passwordWrapper">
      ...
      <View style={styles.passwordContainer}>
        ...
        {selectedDepartment?.password && (
          <TouchableOpacity onPress={() => setFormPasswordVisible(!formPasswordVisible)}>
            <Image 
              ...
              >
                ...
                <View style={styles.tableCellPassword}>
                  <View style={styles.passwordContainer}>
                    ...
                    {item.password && (
                      <TouchableOpacity onPress={() => togglePasswordVisibility(item.deptId)}>
                        <Image 
                ...
                {screenWidth >= 600 && (
                  <View style={styles.tableCellActions}>
                    ...
                    <TouchableOpacity onPress={() => navigateToLabManager(item)} style={styles.iconButton}>
